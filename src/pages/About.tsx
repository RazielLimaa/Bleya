        ...
        <div className="container mx-auto px-6">
          ...
          <div className="grid grid-cols-1  gap-8">
            {team.map((member, index) => (
              ...
              >
                <div className="relative overflow-hidden rounded-xl mb-6 w-32 h-32">
                  <div className="absolute inset-0 bg-gradient-to-t from-purple-900 to-transparent opacity-0 group-hover:opacity-70 transition-opacity duration-300 w-32 h-32" />
                  <img
                    src={member.image}
                    alt={member.name}
                    className="w-32 h-32 object-cover object-center transition-transform duration-500 group-hover:scale-110"
                  />
                </div>
